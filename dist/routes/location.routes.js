...
const createLocation_controller_1 = require("../modules/Location/useCase/createLocation/createLocation.controller");
const locationRouter = (0, express_1.Router)();
const getLocationController = new getLocation_controller_1.GetLocationController();
const createLocationController = new createLocation_controller_1.CreateLocationController();
