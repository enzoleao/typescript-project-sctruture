...
exports.RemovePeopleInMemoryController = void 0;
const removePeopleInMemory_usecase_1 = require("./removePeopleInMemory.usecase");
const AddPeopleInMemory_repository_1 = require("../../repositories/implementations/AddPeopleInMemory.repository");
class RemovePeopleInMemoryController {
    handle(req, res) {
...
exports.RemovePeopleInMemoryController = RemovePeopleInMemoryController;
